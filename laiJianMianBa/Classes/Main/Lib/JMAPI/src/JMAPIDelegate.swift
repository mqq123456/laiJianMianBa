...
@objc public protocol JMAPIDelegate: NSObjectProtocol {
    ...
    ///
    /// - Parameters:
    ///   - request: RequestGetImpressModel
    ///   - response: ResponseGetImpressModel
    @objc optional func jmGetImpressDone(request: RequestGetImpressModel, response: ResponseGetImpressModel)
    /// 评价tags
    ///
    /// - Parameters:
    ///   - request: RequestSetPhotoMatchModel
    ///   - response: ResponseSetPhotoMatchModel
    @objc optional func jmSetPhotoMatchDone(request: RequestSetPhotoMatchModel, response: ResponseSetPhotoMatchModel)
    
    /// 评价tags
    ///
    /// - Parameters:
    ///   - request: RequestUpdateOrderStateMeetedModel
    ///   - response: ResponseUpdateOrderStateMeetedModel
    @objc optional func jmUpdateOrderStateMeetedDone(request: RequestUpdateOrderStateMeetedModel, response: ResponseUpdateOrderStateMeetedModel)
}
